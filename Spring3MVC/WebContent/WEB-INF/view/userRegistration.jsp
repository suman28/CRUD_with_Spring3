				...
				<md-content class="md-padding">
					<div layout="column">
						<div layout-align="center center">
							<h2 class="md-display-4">Contact Us</h2>
						</div>
							<md-input-container flex>
								 <label>First Name</label>
								 <input type="text" placeholder="${editUser.firstName}" name="firstName" data-ng-model="newUser.firstName" />
						 	</md-input-container>
							<md-input-container flex>
								 <label>Last Name</label> 
								 <input type="text" placeholder="${editUser.lastName}" name="lastName" data-ng-model="newUser.lastName" /> 
							</md-input-container>
							<md-input-container flex>
								 <label>User ID</label>
								 <input type="text" name="userId" placeholder="${editUser.userId}" data-ng-model="newUser.userId" />
							 </md-input-container>
							<md-input-container flex>
								 <label>Password</label>
								 <input type="password" name="password" placeholder="${editUser.password}" data-ng-model="newUser.password" /> 
							</md-input-container>
							<md-input-container flex>
								 <label>Re enter password</label>
								 <input type="password" name="rePassword" placeholder="${editUser.rePassword}" data-ng-model="newUser.rePassword" />
							</md-input-container>
							<md-input-container flex> 
								<label>Email</label>
								<input type="email" name="email" placeholder="${editUser.email}" data-ng-model="newUser.email" /> 
							</md-input-container>
							<md-input-container flex> 
								<label>Contact Number</label>
								<input type="text" name="contactNo" placeholder="${editUser.contactNo}" data-ng-model="newUser.contactNo" /> 
							</md-input-container>
						<!-- 	<md-input-container flex> 
